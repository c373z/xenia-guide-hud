...
DECLARE_bool(guide_scanout_opaque);
DECLARE_bool(guide_show_alpha);
DECLARE_bool(guide_alpha_trace);
DECLARE_bool(guide_text_trace);
DECLARE_bool(guide_present_scaled_resolve);
DECLARE_bool(guide_display_overlay);
DECLARE_bool(guide_overlay_without_enable);DECLARE_bool(guide_text_trace_title);
